...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarMain">
      ...
      <img
        src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->username ?? 'User') }}&background=0D8ABC&color=fff&size=36&rounded=true"
        alt="{{ Auth::user()->username ?? 'User' }}"
        width="36"
        height="36"
        class="rounded-circle border border-2 border-secondary"
      />
<span class="ms-2 d-none d-lg-inline fw-medium">{{ Auth::user()->username ?? 'Guest' }}</span>      </a>  
  ...
  <div class="row">
    ...
    <div class="col-12 col-md-3 col-lg-2 mb-4">
      <div class="d-flex flex-column gap-3">
        ...
        <button type="button" class="btn btn-success w-100" data-bs-toggle="modal" data-bs-target="#addNoteModal">
              <i class="bi bi-plus-circle me-1"></i> Add Note
        </button>

        <button type="button" class="btn btn-outline-danger w-100" data-bs-toggle="modal" data-bs-target="#recycleModal">
